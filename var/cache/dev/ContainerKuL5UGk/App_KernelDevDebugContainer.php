...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DishesController' => 'getDishesControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\CategoryController', 'App\\Controller\\DishesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'nelmio_cors.map' => [
                '^/' => [
                    'allow_origin' => [
                        0 => 'https://bistro-delight-aws.netlify.app',
                    ],
                    'allow_headers' => true,
                    'allow_methods' => [
                        0 => 'GET',
